defmodule Carnet.AffiliatesCovenants.AffiliateCovenant do
  use Ecto.Schema
  ...
  schema "affiliates_covenants" do
    ...
    belongs_to(:titulares, Carnet.Affiliates.Affiliate, foreign_key: :titular_id)
    belongs_to(:beneficiarios, Carnet.Affiliates.Affiliate, foreign_key: :beneficiario_id)
    belongs_to(:covenants, Carnet.Covenants.Covenant, foreign_key: :covenant_id)
